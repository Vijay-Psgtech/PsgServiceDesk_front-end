...
export default function TicketCard({ ticket }) {
  ...
  return (
    <motion.div
      ...
      className="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 p-3 cursor-pointer group relative overflow-hidden"
    >
      {isWorking && (
        <motion.div
          initial={{ opacity: 0 }}
      ...
      <div className="flex justify-between items-center relative z-10">
        ...
        <div className="flex gap-2 text-gray-400">
          <MessageCircle size={16} className="hover:text-rose-600 cursor-pointer" />
